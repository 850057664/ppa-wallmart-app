...
export class PotentialRecoveryComponent implements OnInit {
  // **************************************************************************************
  // Variable start
  ...
  listOfChangeStatus: string[] = [];
  change_reason_value: string = '';
  change_status_value:string = '';
  isChangePRstatusVisible: boolean = false;
  ListOfChangeStatus = ['Not Assigned', 'In Progress', 'Deduction Created', 'Immaterial/Negative', 'Completed/Reviewed'];
